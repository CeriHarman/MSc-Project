...
def fish(params, sample_sizes, length, seed, reco, generation_time=6):
    ...
    demographic_events.append(msprime.PopulationParametersChange(time=0, initial_size=40_000, growth_rate=0))
    ...
    add_demographic_event(40_000, 20_000, 1, 5)
    add_demographic_event(20_000, 40_000, 6, 10)
    add_demographic_event(40_000, 50_000, 11, 15)
    add_demographic_event(50_000, 60_000, 16, 20)
    add_demographic_event(60_000, 40_000, 21, 30)
    add_demographic_event(40_000, 10_000, 31, 40)

    for t in range(41, 45):
        demographic_events.append(msprime.PopulationParametersChange(time=t / generation_time, initial_size=10_000))
...
def repeat_simulations(params, sample_sizes, length, reco, generation_time, num_simulations, seed=None):
    ...
    save_results_to_csv(results, 'bass_results.csv')
