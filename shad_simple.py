...
def fish(params, sample_sizes, length, seed, reco, generation_time=6):
    ...
    demographic_events.append(msprime.PopulationParametersChange(time=0, initial_size=10_000, growth_rate=0))
    ...
    add_demographic_event(10_000, 900, 31, 60) #31 60
    for t in range(61, 126):
        demographic_events.append(msprime.PopulationParametersChange(time=t / generation_time, initial_size=900))
    add_demographic_event(900, 12_000, 125, 200)
